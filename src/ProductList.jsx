...
function ProductList() {
    ...
    const totalQuantity = useSelector(state => state.cart.items.reduce((total, item) => total + item.quantity, 0)); // Calculate total quantity
    const dispatch = useDispatch();
    // Populate plantsArray with your provided plant data
    const plantsArray = [
        {
